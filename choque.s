...
ElChoqueASMB:
    ...
    BL Clear
    MOV R4, #0 // Inicializar DISPLAY con 0
    LDR R11, =DELAY_2 // Cargar la dirección de DELAY_2
    LDR R6, [R11] // Cargar el valor de DELAY_2
    LDR R9, =DELAY // Cargar la dirección de DELAY
    STR R6, [R9] // Asignar DELAY_2 a DELAY
...
for:
    ...
    BLT for // Si i < 7, repetir el bucle
